...
export function CourseRail({
  ...
  return (
    <div>
      ...
      <div className="rail -mx-4 mt-4 max-md:flex max-md:items-stretch max-md:gap-3 max-md:px-4 max-md:pb-1 md:mx-0 md:grid md:grid-cols-2 md:gap-4 md:overflow-x-visible lg:grid-cols-3">
        {courses.map((course) => {
