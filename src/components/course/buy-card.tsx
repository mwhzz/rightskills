...
export function CourseBuyCard({
  ...
  return (
      <div className="overflow-hidden rounded-none border-y bg-card sm:rounded-2xl sm:border lg:rounded-3xl lg:shadow-[0_20px_60px_-28px_rgba(180,70,20,0.28)]">
        <div id="preview">
          <HomeVideo
        ...
        <div className="p-5 sm:p-6 max-lg:hidden">
          ...
          <ul className="mt-6 hidden space-y-3 text-base lg:block">
